...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    description:
      "Nine distinct solid hardwood pool table models with lifetime structural guarantee. Available in 7-foot and 8-foot sizes. Dealer exclusive.",
    openGraph: {
      title: "Pool Tables | C.L. Bailey & Co.",
      description:
        "Nine distinct solid hardwood pool table models with lifetime structural guarantee. Available in 7-foot and 8-foot sizes.",
      type: "website",
    },
    alternates: {
      canonical: `https://clbailey.com/${locale}/products/pool-tables`,
      languages: {
        en: "https://clbailey.com/en/products/pool-tables",
        es: "https://clbailey.com/es/products/pool-tables",
      },
    },
  };
}

export default async function PoolTablesPage({ params }: PageProps) {
  const { locale } = await params;
