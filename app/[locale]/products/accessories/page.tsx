...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    description:
      "Premium billiard accessories including professional-grade ball sets, handcrafted leather pockets, and table covers. Dealer exclusive.",
    openGraph: {
      title: "Accessories | C.L. Bailey & Co.",
      description:
        "Premium billiard accessories including professional-grade ball sets, handcrafted leather pockets, and table covers.",
      type: "website",
    },
    alternates: {
      canonical: `https://clbailey.com/${locale}/products/accessories`,
      languages: {
        en: "https://clbailey.com/en/products/accessories",
        es: "https://clbailey.com/es/products/accessories",
      },
    },
  };
}
